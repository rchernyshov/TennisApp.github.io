...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function initMovementList() {
        ExerciseList[0].push(new Exercise("icons/П1.jpg", "Приставные шаги", "Передвижение приставными шагами правым и левым боком. 4 шага в одну сторону и в обратную сторону не меняя положение тела, 30 секунд"));
        ExerciseList[0].push(new Exercise("icons/П2.jpg", "Стойка теннисиста", "Передвижение приставными шагами правым и левым боком в стойке теннисиста. 4 шага в одну сторону и в обратную сторону не меняя положение тела, 30 секунд"));
